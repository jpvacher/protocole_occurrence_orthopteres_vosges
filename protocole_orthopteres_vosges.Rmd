...
Pour cela, nous définissons dans un premier temps une grille de 100m $\times$ 100m qui se superpose à la grille des échantillons.
...
Chaque réplicat sera numéroté de 1 à 5 dans les mailles, et contiendra le numéro de la maille dans la table de métadonnées.
