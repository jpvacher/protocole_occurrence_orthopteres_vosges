...
# Objectif du suivi et indicateur mesuré
...
Afin d'apprécier l'effet des changement climatiques sur les Orthoptères du Grand Est, le protocole de suivi standardisé proposé dans le présent document a pour objectif de mesurer la variation de la répartition altitudinale du cortège d'Orthoptères du massif des Vosges.
...
* Unité d'échantillonnage : une maille de 500m x 500m
